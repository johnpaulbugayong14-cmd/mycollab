...
// Capacitor WebViews can drop Firestore's default streaming transport. Long polling
// keeps writes and real-time listeners reliable on Android and iOS mobile builds.
export const db = initializeFirestore(app, {
  experimentalForceLongPolling: true,
  useFetchStreams: false
});
console.log('[FIREBASE] DB_INIT', {
  projectId: firebaseConfig.projectId,
  longPolling: true,
  useFetchStreams: false,
  instance: 'db'
